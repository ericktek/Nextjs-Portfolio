...
const navbar = () => {
  ...
  return (
    <div className=" bg-white/10">
      <div className=" px-4 py-6 mx-auto sm:max-w-xl md:max-w-full lg:max-w-5xl md:px-24 lg:px-8">
        <div className="relative grid items-center grid-cols-2 lg:grid-cols-3 ">
          ...
          <ul className="items-center hidden space-x-8 lg:flex">
            <li className="cursor-pointer text-orange-400 border-custo hover:border-orange-400 focus:border-b-2 focus:border-orange-400">
          ...
          <ul className="items-center hidden ml-auto space-x-8 lg:flex">
            <li className="flex duration-200 justify-center items-end cursor-pointer underline-custo underline-offset-4 hover:text-white/90  hover:translate-x-1 hover:text-orange-400">
