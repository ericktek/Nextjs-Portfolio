        ...
        <span className="sr-only">Loading...</span>
              ...
              <div key={post._id} className="lg:flex">
                ...
                <div className="flex flex-col justify-between py-6 lg:mx-6">
                  ...
                  <span onClick={() => handleDelete(post._id)} className='text-xs text-red-500 cursor-pointer '>Delete</span>
          ...
          <div className="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:m-0 pb-12 ">
            ...
            {successMessage && <p className="text-green-500">{successMessage}</p>} 
              ...
              <div className="relative mb-4">
                ...
                <input value={image} onChange={(e) => setImage(e.target.value)} name="image" className="w-full bg-transparent rounded border border-gray-300 focus:border-orange-400 focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-300 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
              </div>
              <div className="relative mb-4">
